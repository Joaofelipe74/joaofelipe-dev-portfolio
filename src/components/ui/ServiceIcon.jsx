/**
 * Ícones em SVG inline (sem dependência externa) para os cards de serviços.
 * Todos seguem o mesmo grid 24x24 e herdam a cor via `currentColor`.
 */
const ICONS = {
  globe: (
    <>
  ...
  layers: (
    <>
      ...
      <path d="m3 8 9 5 9-5" strokeOpacity="0" />
    </>
  ),
  code: (
    <>
  ...
  link: (
    <>
      ...
      <path d="M7 17a4 4 0 0 1 0-5.7l1.5-1.5" />
      <path d="M17 7a4 4 0 0 1 0 5.7l-1.5 1.5" />
    </>
  ),
